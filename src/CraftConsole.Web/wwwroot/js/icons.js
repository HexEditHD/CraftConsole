...
const P = {
  ...
  arrowUp:   '<path d="M12 20V4.5"/><path d="M5.5 11 12 4.5 18.5 11"/>',
  house:     '<path d="M3.5 10.5 12 3.5l8.5 7"/><path d="M5.5 9.75V19.5a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V9.75"/>',
  drive:     '<rect x="3" y="4.5" width="18" height="15" rx="1"/><path d="M3 9.5h18"/><path d="M6.5 7h.01"/>',
