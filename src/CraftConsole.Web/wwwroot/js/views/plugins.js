      ...
      body.append(h('div', { class: 'table-wrap' }, h('table', { class: 'table' },
        ...
        h('tbody', {}, data.plugins.map(p => h('tr', {},
          h('td', {},
            ...
            h('div', { class: 'muted small mono' }, p.fileName)),
          h('td', {}, p.version ? h('span', { class: 'badge' }, p.version) : h('span', { class: 'muted' }, '—')),
          h('td', { class: 'text-2' }, p.author || '—'),
          h('td', { class: 'text-2 small', style: { maxWidth: '340px' } },
